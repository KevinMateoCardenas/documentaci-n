...
Estos son solo ejemplos ilustrativos de cómo se pueden utilizar las claves primarias y foráneas en SQL. La estructura y diseño de las tablas dependerá de los requerimientos específicos de tu aplicación y modelo de datos.
...
¡Claro! Aquí tienes un ejemplo para ilustrar la Tercera Forma Normal (3NF):
