...
// Configuracion y servicios adicionales
// ...

var app = builder.Build();

// Configuracion del pipeline de solicitud
// ...

app.Run();
\end{lstlisting}

En este programa, se crea un \enquote*{WebApplicationBuilder} utilizando el método \enquote*{WebApplication.CreateBuilder(args)}. A continuación, se pueden realizar configuraciones adicionales y agregar servicios necesarios para la aplicación.
...
Y este podría ser el controlador que de esta respuesta:
...
public class ExampleController : ControllerBase
{
    ...
    public IActionResult Get()
    {
        // Codigo de implementacion para el metodo GET. Aqui puedes obtener los datos solicitados y construir la respuesta
    ...
    {
        // Codigo de implementacion para el metodo POST. Aqui puedes crear un nuevo recurso y construir la respuesta
        var newResource = new
        {
            id = 2,
            name = "Jane Smith",
    ...
    {
        // Codigo de implementacion para el metodo PUT. Aqui puedes actualizar el recurso existente y construir la respuesta
    ...
    public IActionResult Delete(int id)
    {
        // Codigo de implementacion para el metodo DELETE. Aqui puedes eliminar el recurso con el ID proporcionado y construir la respuesta
