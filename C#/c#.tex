...
El enfoque en objetos permite la modularidad y el encapsulamiento, lo que hace que el código sea más fácil de mantener y extender. Además, la POO hace uso de conceptos como la herencia, la polimorfismo y el encapsulamiento, que permiten una mayor flexibilidad y reutilización de código.

\subsection{Clases y objetos}

En programación orientada a objetos, una clase es una plantilla o modelo que describe las propiedades y métodos que tendrán los objetos creados a partir de ella. Por lo tanto, una clase es un concepto abstracto que define la estructura y comportamiento de los objetos.
...
public class Persona {
    ...
    // metodo
    public void Saludar(){
        Console.WriteLine("Hola, mi nombre es " + nombre + " y tengo " + edad + " a~nos.");
    }
}
\end{lstlisting}
...
Este código imprimirá en la consola el mensaje \enquote*{Hola, mi nombre es Juan y tengo 30 años.}, utilizando los valores de las propiedades del objeto creado.
